...
export const uranusI18nOrgTranslations: Record<string, Record<UranusLocaleKey, string>> = {
    org: {
        de: 'Organisation',
        en: 'Organization',
        da: 'Organisation',
