...
export const uranusI18nUserTranslations: Record<string, Record<UranusLocaleKey, string>> = {
    ...
    invite_accept_no_action_required_message: {
        ...
        da: "Ingen yderligere handling er nødvendig — din konto er fuldt opsat og klar til brug.",
    },
    invite_accept_permissions_info_message: {
        de: "Du kannst nun entsprechend deiner Berechtigungen Inhalte bearbeiten und Aktionen ausführen. Alle deine Mitgliedschaften und Zugriffsrechte findest du auf deiner Profilseite.",
        ...
        da: "Du kan nu udføre handlinger og redigere indhold baseret på dine rettigheder. Du kan se alle dine medlemskaber og adgangsrettigheder på din profilside.",
    },
    invite_accept_membership_help_message: {
        de: "Wenn du mehr darüber erfahren möchtest, wie Teammitgliedschaften funktionieren, einschließlich Rollen und Berechtigungen, kannst du hier mehr lesen:",
        en: "If you’d like to learn more about how team membership works, including roles and permissions, you can read more here:",
        da: "Hvis du vil vide mere om, hvordan teammedlemskab fungerer, herunder roller og rettigheder, kan du læse mere her:",
    },
