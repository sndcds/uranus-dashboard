...
const messages = {
    ...
    da: {
        ...
        events_title: 'Arrangementer',
        events_subtitle: 'Få overblik over kommende aktiviteter.',
        events_loading: 'Indlæser arrangementer…',
        events_empty: 'Ingen arrangementer planlagt endnu.',
        events_fetch_failed: 'Kunne ikke indlæse arrangementer (status {status}).',
        events_fetch_failed_generic: 'Kunne ikke indlæse arrangementer.',
