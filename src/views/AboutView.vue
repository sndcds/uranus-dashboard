...
watchEffect(async () => {
  try {
    ...
    const module = await import(`../pages/about/${locale.value}.html?raw`)
    htmlContent.value = module.default
  } catch (err) {
    htmlContent.value = `../pages/about/${locale.value}.html?raw`
...
/* You can keep all other styles from your previous AboutUs.vue here */
</style>