<!--
  UranusPublicEventVenueDisplay.vue
-->
<template>
...
import type {UranusPublicEventDetail} from "@/models/UranusPublicEventModel.ts";

const { t } = useI18n({ useScope: 'global' })

// Accept the entire currentEventDate object
const props = defineProps<{ event: UranusPublicEventDetail | null }>()
