...
const inboxTitle = computed(() => t('dashboard_message_send_title'))
const searchLabel = computed(() => t('dashboard_message_search_label'))
const searchPlaceholder = computed(() => t('dashboard_message_search_placeholder'))
const searchButtonLabel = computed(() => t('dashboard_message_search_cta'))
const searchingLabel = computed(() => t('dashboard_message_searching'))
const searchResultsLabel = computed(() => t('dashboard_message_results_label'))
const noResultsLabel = computed(() => t('dashboard_message_no_results'))
const searchErrorFallback = computed(() => t('dashboard_message_search_error'))
