...
const placeholderLabel = computed(() => t('dashboard_message_placeholder'))
const recipientLabel = computed(() => t('dashboard_message_recipient_label'))
const subjectLabel = computed(() => t('dashboard_message_subject_label'))
const subjectPlaceholder = computed(() => t('dashboard_message_subject_placeholder'))
const messageLabel = computed(() => t('dashboard_message_body_label'))
const messagePlaceholder = computed(() => t('dashboard_message_body_placeholder'))
const sendButtonLabel = computed(() => t('dashboard_message_send_cta'))
const sendingLabel = computed(() => t('dashboard_message_sending'))
const missingFieldsMessage = computed(() => t('dashboard_message_missing_fields'))
const sendErrorFallback = computed(() => t('dashboard_message_send_error'))
const sendSuccessMessage = computed(() => t('dashboard_message_send_success'))
