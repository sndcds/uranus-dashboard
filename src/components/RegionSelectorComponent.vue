<template>
    <UranusFieldLabel :label="countryLabel" :required="true" :error="stateError">
      <select
    ...
    <!-- State -->
    <UranusFieldLabel :label="stateLabel" :required="true" :error="stateError">
      <select
          v-model="stateModel"
          :disabled="statesLoading || !countryModel"
          class="uranus-select"
          :aria-required="true"
