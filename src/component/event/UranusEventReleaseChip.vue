...
const label = computed(() => {
  if (props.releaseStatus === 'draft') return t('event_release_draft')
  if (props.releaseStatus === 'review') return t('event_release_review')
  if (props.releaseStatus === 'released') return t('event_release_released')
  if (props.releaseStatus === 'cancelled') return t('event_release_cancelled')
  if (props.releaseStatus === 'deferred') return t('event_release_deferred')
  if (props.releaseStatus === 'rescheduled') return t('event_release_rescheduled')
  return ''
})
