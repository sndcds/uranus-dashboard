/*
    src/domain/org/orgListItem.model.ts
*/
 ...
 */
export function mapOrgListItem(dto: OrgListItemDTO): OrgListItem {
    return {
        uuid: dto.uuid,
        name: dto.name,
        city: dto.city ?? null,
 ...
 */
export function toOrgListItemDTO(model: OrgListItem): OrgListItemDTO {
    return {
        uuid: model.uuid,
        name: model.name,
 ...
 */
export function createEmptyOrgListItem(): OrgListItem {
    return {
        uuid: '',
        name: '',
        city: null,
