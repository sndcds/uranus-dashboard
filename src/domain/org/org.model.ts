 ...
 */
export function mapOrg(dto: OrgDTO): OrgModel {
    return {
        uuid: dto.uuid ?? null,
        name: dto.name ?? '',
        ...
        holdingOrgUuid: dto.holding_org_uuid ?? null,
 ...
 */
export function toOrgDTO(model: OrgModel): OrgDTO {
    return {
        uuid: model.uuid,
        name: model.name,
        ...
        holding_org_uuid: model.holdingOrgUuid ?? null,
 ...
 */
export function createEmptyOrg(): OrgModel {
    return {
        uuid: null,
        name: '',
        description: null,
